...
import RecommendationDTO from "../protocols/RecommendationDTO";

export async function create(recommendationDTO: RecommendationDTO) {
  const {name,youtubeLink, score} = recommendationDTO;
